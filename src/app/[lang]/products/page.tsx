...
export default async function ProductsPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return (
    <main className="min-h-screen bg-slate-50 selection:bg-blue-600 selection:text-white">
      {/* ── Header Section ───────────────────── */}
      <div className="relative bg-[#020617] pt-24 pb-12 px-6 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10 text-center space-y-6">
          ...
          <h1 className="text-5xl md:text-7xl font-black text-slate-200 tracking-tighter leading-none">
