    ...
    <main ref={containerRef} className="min-h-screen bg-[#020617] text-white selection:bg-amber-500 selection:text-black pt-20">
      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden px-6">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-12">
             <div className="military-panel p-8 rounded-3xl space-y-2 border-amber-500/10">
      ...
      <section className="py-32 px-6 bg-[#01040a]">
         <div className="max-w-6xl mx-auto">
            ...
            <div className="relative aspect-[21/9] bg-[#020617] rounded-[3rem] border border-white/5 p-12 overflow-hidden shadow-2xl">
            ...
            <div className="mt-12 flex justify-center">
              <Link 
                ...
                className="military-panel px-10 py-5 bg-amber-950/30 text-white rounded-2xl font-bold text-xs uppercase tracking-widest hover:border-amber-500 transition-all flex items-center gap-3 border border-white/5 group shadow-2xl"
              >
                {isEn ? "Request IIoT Architecture Consultation" : "Tư vấn kiến trúc IIoT chuyên sâu"}
                <ArrowRight className="w-4 h-4 group-hover:translate-x-1.5 transition-transform text-amber-500" />
              </Link>
            </div>
         </div>
      </section>
               ...
               <div className="space-y-4 pt-4">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-3 text-slate-300 font-semibold group">
                       <ShieldCheck className="w-5 h-5 text-amber-500 group-hover:scale-125 transition-transform" />
                       {isEn ? feat : (
