            ...
            <article key={item.id} className="bg-white rounded-lg border border-slate-200 shadow-sm hover:border-slate-300 hover:shadow-md transition-all duration-300 group overflow-hidden flex flex-col">
              ...
              <div className="p-6 flex flex-col flex-grow space-y-4">
                <div className="flex justify-between items-center text-xs">
                  <span className="flex items-center gap-1.5 text-cyan-700 bg-cyan-50 px-2.5 py-1 rounded-sm font-semibold">
                ...
                <div className="flex-grow space-y-2">
                  <h3 className="text-lg font-bold text-slate-900 leading-snug group-hover:text-cyan-600 transition-colors">
                    <Link href={`/${lang}/blog/${item.id}`}>
                      {item.title}
                    </Link>
                  </h3>
                ...
                <div className="pt-4 border-t border-slate-100 flex justify-between items-center">
                  <Link
                    ...
                    className="text-xs font-semibold text-cyan-600 group-hover:text-cyan-700 transition-colors flex items-center gap-1.5"
                  >
                    {d.readMore}
