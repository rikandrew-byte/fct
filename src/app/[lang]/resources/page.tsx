...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  return {
    title: `${dict.navbar.resources || "Tài liệu & Hỏi đáp"} | FCT Vĩnh Thịnh`,
    description: dict.knowledge.hero.description,
    openGraph: {
      title: `${dict.navbar.resources || "Tài liệu & Hỏi đáp"} - Chuyên gia bảo vệ bản quyền & an ninh mạng`,
      description: dict.knowledge.hero.description,
      type: "website",
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: dict.navbar.resources || "Tài liệu & Hỏi đáp",
        },
      ],
    },
    twitter: {
...
export default async function ResourcesPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return (
    <>
      ...
      />
      <ResourcesPageClient lang={lang} dict={dict} />
    </>
  );
}
