          ...
          {projectsData.map((project, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="bg-gray-900/40 backdrop-blur-3xl border border-white/5 rounded-[2.5rem] p-8 md:p-12 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start hover:border-blue-500/30 transition-all duration-500 shadow-2xl">
      ...
      <section className="py-32 px-6">
        <div className="max-w-4xl mx-auto p-12 bg-gradient-to-br from-blue-600 to-blue-900 rounded-[3.5rem] text-center space-y-8 relative overflow-hidden group shadow-2xl">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button className="bg-white text-blue-950 px-10 py-5 rounded-2xl font-black text-sm uppercase tracking-widest hover:scale-105 transition-all shadow-xl">
              Gửi yêu cầu tư vấn
            </button>
