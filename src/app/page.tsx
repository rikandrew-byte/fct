...
export default function Home() {
  return (
    <div className="min-h-screen bg-white text-gray-900 font-sans selection:bg-blue-500 selection:text-white pb-20 overflow-x-hidden">
        ...
        <div className="text-center max-w-5xl mx-auto space-y-10 z-10">
          ...
          >
            ...
            <div className="relative overflow-hidden bg-blue-900/30 backdrop-blur-xl border border-blue-400/40 rounded-full px-8 py-2.5 text-[11px] font-black text-blue-200 tracking-[0.3em] shadow-2xl uppercase">
              <span className="relative z-10 font-black">🛡️ CHUYÊN GIA BẢO MẬT & BẢN QUYỀN PHẦN MỀM</span>
      ...
      {/* Trust & Confidentiality Section - DARK SYNC */}
      <section className="border-b border-white/5 bg-[#020617] py-16 relative overflow-hidden">
        <div className="max-w-5xl mx-auto px-6 text-center space-y-8">
          <div className="flex flex-wrap justify-center gap-x-12 gap-y-6 text-gray-500 font-black text-xs md:text-sm tracking-[0.4em] uppercase opacity-80">
            <div className="hover:text-blue-400 transition-colors cursor-default">Ngân hàng</div>
            <div className="hover:text-blue-400 transition-colors cursor-default">Chính phủ</div>
            <div className="hover:text-blue-400 transition-colors cursor-default">Tài chính</div>
          ...
          <div className="flex items-center justify-center gap-4 text-gray-600">
            ...
            <p className="text-[11px] font-bold uppercase tracking-[0.2em] italic text-blue-400/80">
              "Cam kết bảo vệ tuyệt đối danh tính và dự án của khách hàng theo chính sách bảo mật (NDA Strict Policy)"
            </p>
            <div className="h-px w-12 bg-white/10"></div>
          </div>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-6 mb-32 pt-20">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-4">
          <div className="space-y-4 text-center md:text-left">
            <h2 className="text-sm font-black text-blue-600 tracking-[0.4em] uppercase">Hệ sinh thái giải pháp</h2>
            <h3 className="text-4xl md:text-7xl font-black text-gray-950 tracking-tighter leading-none">An tâm tuyệt đối với <br /><span className="text-blue-600">Công nghệ lõi</span></h3>
          </div>
          <Link href="/news" className="text-blue-600 font-semibold hover:underline flex items-center gap-2 group text-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-8 auto-rows-[340px]">
          ...
          >
            ...
            <h3 className="relative z-10 text-3xl font-black text-gray-950 mb-4 tracking-tighter">Bảo mật Di động</h3>
            <p className="relative z-10 text-gray-500 text-base font-light leading-relaxed max-w-sm">
              Giải pháp bảo vệ đa lớp từ <strong className="text-gray-950">Guardsquare</strong>, ngăn chặn dịch ngược và bảo vệ mã nguồn tối ưu cho ứng dụng.
            </p>
          </motion.div>
          ...
          >
            ...
            <h3 className="relative z-10 text-3xl font-black text-gray-950 mb-4 tracking-tighter">Quản lý Bản quyền</h3>
            <p className="relative z-10 text-gray-500 text-base font-light leading-relaxed max-w-sm">
              Giải pháp <strong className="text-gray-950">Sentinel</strong> từ Thales giúp cấp phép và bảo mật dữ liệu doanh nghiệp an toàn tuyệt đối.
            </p>
          </motion.div>
          ...
          >
            ...
            <h3 className="relative z-10 text-3xl font-black text-gray-950 mb-4 tracking-tighter">Bảo mật Phần cứng</h3>
            <p className="relative z-10 text-gray-500 text-base font-light leading-relaxed max-w-sm">
              An tâm với dòng sản phẩm <strong className="text-gray-950">Longmai</strong> — giải pháp xác thực 2 lớp và khóa cứng tiêu chuẩn quốc tế.
            </p>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <h3 className="relative z-10 text-3xl font-black tracking-tighter">Xem Hệ sinh thái FCT</h3>
              <p className="relative z-10 text-blue-100/70 text-base mt-4 font-light max-w-[280px] leading-relaxed">Tiên phong bảo vệ <br /> hạ tầng kinh tế số của bạn</p>
            </Link>
          </motion.div>
