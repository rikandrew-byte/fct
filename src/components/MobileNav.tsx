    ...
    <div className="lg:hidden">
      ...
      >
        <Link href={`/${lang}`} className="flex items-center gap-2.5 z-50">
          <Image src="/logo.png" alt="FCT Vinh Thinh Logo" width={36} height={36} className="object-contain drop-shadow-[0_0_8px_rgba(6,182,212,0.2)]" />
        ...
        <div className="fixed inset-0 z-[100] bg-white/98 backdrop-blur-2xl flex flex-col justify-start pt-20 landscape:pt-16 px-6 sm:px-8 animate-in fade-in slide-in-from-top-4 duration-300 overflow-y-auto">
          <nav className="flex flex-col gap-8">
            ...
            <button 
              ...
              className="mt-6 text-center px-6 py-4 bg-cyan-600 rounded-xl text-white font-black text-xs uppercase tracking-widest shadow-lg shadow-cyan-600/20 active:scale-95 transition-transform w-max mx-auto"
            >
